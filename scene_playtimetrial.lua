...
local function setUpDisplay(group)
    -- Clock text
    clockText = display.newText("3:00", 0, 0, display.contentCenterX, screenBottom - 50, "PoetsenOne", 32)
...
function scene:create( event )
    ...
    -- Sets time on the clock for Time Trial Mode
    secondsLeft = 3 * 60
...
function scene:destroy( event )
    ...
    -- NB: QuizDisplay objects are destroyed from within quizmanage when game ends
